...
Section GenericTyping.
  ...
  Class RedTypeProperties :=
  {
    redty_wk {l Γ Δ A B} (ρ : Δ ≤ Γ) :
      [|- Δ ]< l > -> [Γ |- A ⇒* B]< l > -> [Δ |- A⟨ρ⟩ ⇒* B⟨ρ⟩]< l > ;
    redty_sound {l Γ A B} : [Γ |- A ⇒* B]< l > -> [Γ |-[de] A ⇒* B]< l > ;
  ...
  {
    osredtm_beta {l Γ A B t u} :
      [ Γ |- A ]< l > ->
      [ Γ ,, A |- t : B ]< l > ->
      [ Γ |- u : A ]< l > ->
      [ Γ |- tApp (tLambda A t) u ⇒ t[u..] : B[u..] ]< l > ;
    osredtm_natElimZero {l Γ P hz hs} :
        [Γ ,, tNat |- P ]< l > ->
        [Γ |- hz : P[tZero..]]< l > ->
        [Γ |- hs : elimSuccHypTy P]< l > ->
        [Γ |- tNatElim P hz hs tZero ⇒ hz : P[tZero..]]< l > ;
    osredtm_natElimSucc {l Γ P hz hs n} :
        [Γ ,, tNat |- P ]< l > ->
        [Γ |- hz : P[tZero..]]< l > ->
        [Γ |- hs : elimSuccHypTy P]< l > ->
        [Γ |- n : tNat]< l > ->
        [Γ |- tNatElim P hz hs (tSucc n) ⇒ tApp (tApp hs n) (tNatElim P hz hs n) : P[(tSucc n)..]]< l > ;
    osredtm_emptyElim {l Γ P e e'} :
        [Γ ,, tEmpty |- P ]< l > ->
        [Γ |- e ⇒ e' : tEmpty]< l > ->
        [Γ |- tEmptyElim P e ⇒ tEmptyElim P e' : P[e..]]< l > ;
    osredtm_boolElimTrue {l Γ P ht hf} :
        [Γ ,, tBool |- P ]< l > ->
        [Γ |- ht : P[tTrue..]]< l > ->
        [Γ |- hf : P[tFalse..]]< l > ->
        [Γ |- tBoolElim P ht hf tTrue ⇒ ht : P[tTrue..]]< l > ;
    osredtm_boolElimFalse {l Γ P ht hf} :
        [Γ ,, tBool |- P ]< l > ->
        [Γ |- ht : P[tTrue..]]< l > ->
        [Γ |- hf : P[tFalse..]]< l > ->
        [Γ |- tBoolElim P ht hf tFalse ⇒ hf : P[tFalse..]]< l > ;
    osredtm_alphaSubst {l Γ n n'} :
    [ Γ |- n ⇒ n' : tNat ]< l > -> [ Γ |- tAlpha n ⇒ tAlpha n' : tBool ]< l > ;
    osredtm_alphaRed {l Γ n b} :
    [ |- Γ ]< l > ->
    in_LCon (pi1 l) n b ->
    [ Γ |- tAlpha (nat_to_term n) ⇒ bool_to_term b : tBool ]< l > ;
  }.
  ...
  Class RedTermProperties :=
  {
    redtm_wk {l Γ Δ t u A} (ρ : Δ ≤ Γ) :
      [|- Δ ]< l > -> [Γ |- t ⇒* u : A]< l > -> [Δ |- t⟨ρ⟩ ⇒* u⟨ρ⟩ : A⟨ρ⟩]< l > ;
    redtm_sound {l Γ A t u} : [Γ |- t ⇒* u : A]< l > -> [Γ |-[de] t ⇒* u : A]< l > ;
    redtm_ty_src {l Γ A t u} : [Γ |- t ⇒* u : A]< l > -> [Γ |- t : A]< l > ;
    redtm_one_step {l Γ A t u} :
      [ Γ |- t ⇒ u : A ]< l > ->
      [ Γ |- t ⇒* u : A ]< l > ;
    ...
    redtm_boolelim {l Γ P ht hf b b'} :
      ...
      [ Γ |- b : tBool ]< l > ->
      [ Γ |- b ⇒* b' : tBool ]< l > ->
      (forall b, [Γ |- b ⇒* b' : tBool]< l > -> [Γ |- P[b'..] ≅ P[b..]]< l >) ->
      [ Γ |- tBoolElim P ht hf b ⇒* tBoolElim P ht hf b' : P[b..] ]< l >;
    ...
    redtm_alphasubst {l Γ t t'} :
      [Γ |- t ⇒* t' : tNat]< l > ->
      [Γ |- tAlpha t ⇒* tAlpha t' : tBool]< l > ;
  }.
...
Section GenericConsequences.
  ...
  Lemma osredtm_meta_conv l (Γ : context) (t u u' A A' : term) :
    [Γ |- t ⇒ u : A]< l > ->
    A' = A ->
    u' = u ->
    [Γ |- t ⇒ u' : A']< l >.
  ...
  Lemma redtywf_sound {l Γ A B} : [Γ |- A :⇒*: B]< l > -> TypeRedClosure l Γ A B.
  Proof.
  ...
  Proof.
    ...
    - intros l Gamma A B red.
      exact (@redty_ty_src ta WfContext0 WfType0 RedType0 RedTerm0 H5 l Gamma A B red).
    - intros; now eapply redtywf_term.
    - intros; now apply redtywf_refl.
    - intros; now eapply (redtywf_trans (l := l)).      
  Qed.
  ...
  Definition redtmwf_sound {l Γ t u A} :
  ...
  Lemma rtc_osredtm_redtm {l Γ A x y} :
  ...
  Lemma rtc_osredtm_redtmwf {l Γ A x y} :
    reflTransClos (osred_tm l Γ A) x y ->
    [Γ |- y : A]< l > ->
    [Γ |- x :⇒*: y : A]< l >.
  Proof.
  ...
  Lemma osredtm_ty_src {l Γ t u A} : [Γ |- t ⇒ u : A]< l > -> [Γ |- t : A]< l >.
  Proof.
  ...
  Lemma osredtm_comp_beta {l Γ A B C f g a} :
    [Γ |- A]< l > ->
    [Γ |- B]< l > ->
    [Γ |- C]< l > ->
    [Γ |- f : arr A B]< l > ->
