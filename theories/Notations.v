...
Class ConvNeuList (ta : tag) := conv_neu_list : context -> term -> term -> term -> Set.
...
Notation "[ Γ |- n ~ n' :List A ]" := (conv_neu_list Γ A n n')
  (at level 0, Γ, n, n', A at level 50, only parsing) : typing_scope. 
Notation "[ Γ |-[ ta  ] n ~ n' :List A ]" := (conv_neu_list (ta := ta) Γ A n n')
  (at level 0, ta, Γ, n, n', A at level 50) : typing_scope.
