...
Reserved Notation "[ Γ ||-U k ]" (at level 0, Γ, k at level 50).
...
Reserved Notation "[ Γ ||-v< k > A | VΓ ]" (at level 0, Γ, k , A, VΓ at level 50).
...
Reserved Notation "[ P | Γ ||-v< k > A ]"  (at level 0, P, Γ, k, A at level 50).
