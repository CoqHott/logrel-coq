...
Record typeValidity@{u i j k l} `{ta : tag} `{!WfContext ta}
  ...
  `{!ConvTerm ta} `{!ConvNeuConv ta} `{!RedType ta} `{!TypeNf ta} `{!TypeNe ta} `{!RedTerm ta} `{!TermNf ta} `{!TermNe ta}
...
Arguments typeValidity {_ _ _ _ _ _ _ _ _ _ _ _ _}.
...
Arguments snocValidSubst : clear implicits.
Arguments snocValidSubst {_ _ _ _ _ _ _ _ _ _ _ _ _}.

Arguments snocEqSubst : clear implicits.
Arguments snocEqSubst {_ _ _ _ _ _ _ _ _ _ _ _ _}.

Arguments snocVPack : clear implicits.
Arguments snocVPack {_ _ _ _ _ _ _ _ _ _ _ _ _}.
...
Section MoreDefs.
  ...
  `{ConvType ta} `{ConvTerm ta} `{ConvNeuConv ta} `{RedType ta} `{!TypeNf ta} `{!TypeNe ta} `{RedTerm ta} `{!TermNf ta} `{!TermNe ta}.
...
Arguments termValidity {_ _ _ _ _ _ _ _ _ _ _ _ _}.
Arguments Build_termValidity {_ _ _ _ _ _ _ _ _ _ _ _ _}.

Arguments typeEqValidity : clear implicits.
Arguments typeEqValidity {_ _ _ _ _ _ _ _ _ _ _ _ _}.
Arguments Build_typeEqValidity {_ _ _ _ _ _ _ _ _ _ _ _ _}.

Arguments termEqValidity : clear implicits.
Arguments termEqValidity {_ _ _ _ _ _ _ _ _ _ _ _ _}.
Arguments Build_termEqValidity {_ _ _ _ _ _ _ _ _ _ _ _ _}.

Arguments tmEqValidity : clear implicits.
Arguments tmEqValidity {_ _ _ _ _ _ _ _ _ _ _ _ _}.
Arguments Build_tmEqValidity {_ _ _ _ _ _ _ _ _ _ _ _ _}.

Arguments redValidity : clear implicits.
Arguments redValidity {_ _ _ _ _ _ _ _ _ _ _ _ _}.
Arguments Build_redValidity {_ _ _ _ _ _ _ _ _ _ _ _ _}.
...
Definition wfCtxOfsubstS `{GenericTypingProperties}
  `{TypeNf ta} `{TypeNe ta} `{TermNf ta} `{TermNe ta}
  {Γ Δ σ} {VΓ : [||-v Γ]} {wfΔ : [|- Δ]} :
