...
Module Type LogRelRec.
  ...
  Parameter URel@{i | u < i}    : context         -> Type@{i}.
  Parameter PiRel@{i | u < i}   : context -> term -> Type@{i}.
  Parameter TyRel@{i | u < i}   : context -> term -> Type@{i}.
  Parameter EqTyRel : forall (Γ : context) (A B : term)  , TyRel Γ A -> Type@{u}.
  Parameter TeRel   : forall (Γ : context) (t A : term)  , TyRel Γ A -> Type@{u}.
  Parameter EqTeRel : forall (Γ : context) (t u A : term), TyRel Γ A -> Type@{u}.
...
Axiom todo : forall {a : Type}, a.
  ...
  Inductive LR@{i j | i < j} : RedRel@{i j} := 
